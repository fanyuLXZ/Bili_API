package com.dreamwolf.client_userDynamic;
...
public class Automatically {
    ...
    public void Automatice(){
        ...
        strategy.setInclude("userdynamic","dynamicdata","dynamiclike","dynamiccomment");//设置要映射的表名
        ...
        pc.setParent("com.dreamwolf.client_userDynamic");
        pc.setEntity("entity");
        pc.setMapper("mapper");
