...
import com.dreamwolf.entity.member.web_interface.ExpReward;
...
public class VipController {
    ...
    public ResponseData<VipInfo> reward(){
        ...
        VipInfo vipInfo=new VipInfo(vip.getuID()!=null,month+"/"+day_of_month=="4/1"?0:1,vip.getExpirationTime());
